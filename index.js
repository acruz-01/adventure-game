...
let endStayDragon = 'You and the dragon have an uplifting conversation about local politics and become lifelong friends.';
let endRunDragon = 'Quickly, you run back to the cave \'s entrance. Sheepish, you return home.';
...
if (answer == 'left') {                       //Answer Left if else and nested 
...
} else if (answer == 'right') { //Answer Right if else and nested 
  answer = window.prompt(qBeginContinue);
  if (answer == 'past the dragon') {
    answer = window.prompt(qPastDragon);
    if (answer == 'stay') {
      answer = window.alert(endStayDragon);
    } else if (answer = 'run')
    answer = window.alert(endRunDragon);
  } else if (answer == 'away from the dragon') {
    answer = window.prompt(qAwayDragon);
    if (answer == 'draw it') {
      answer = window.alert(endDrawItDragon);
    } else if (answer == 'pick it') {
      answer = window.alert(endPickItDragon);
    }
  }
}